...
#'
#' A function to suggest to user a set of features based on sivs object and the provided strictness
#'
#' @param object The object that is produced by the sivs function.
#' @param strictness A numerical vector of length 1 showing how strict the suggestion should be, ranging from 0 to 1 where 0 is less strict and 1 is the most strict. Default value is 0.01. For more information, check read the Details section.
...
#'     sivs. Note that this function is suppose to give the feature space based
#'     on the cutoff and hence the intercept (if exists in the VIMP) will be
#'     excluded from the output.
#'
#' @return A character vector that contains the names of suggeted features based
