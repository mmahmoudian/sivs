...
# bypass CRAN's error on number of used cores!
...
<!--
```r
utils::download.file(url = "https://archive.ics.uci.edu/ml/machine-learning-databases/arcene/ARCENE/arcene_train.data", destfile = "arcene_train.data")
utils::download.file(url = "https://archive.ics.uci.edu/ml/machine-learning-databases/arcene/ARCENE/arcene_train.labels", destfile = "arcene_train.labels")

utils::download.file(url = "https://archive.ics.uci.edu/ml/machine-learning-databases/arcene/ARCENE/arcene_valid.data", destfile = "arcene_valid.data")
utils::download.file(url = "https://archive.ics.uci.edu/ml/machine-learning-databases/arcene/arcene_valid.labels", destfile = "arcene_valid.labels")
```
-->
...
Now we can run SIVS to get the most important features. Note that for the sake of making the vignette, the progressbar is set to FALSE and the verbosity has set to none so that the function does not print its progress.

```r
library("sivs")

sivs_obj <- sivs::sivs(x = train_x,
                       y = factor(train_y),
                       verbose = "none",
                       progressbar = FALSE)
```
